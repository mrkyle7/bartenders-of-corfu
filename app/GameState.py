...
class GameState:
    ...
    def __init__(self, winner: Optional[UUID], bag_contents: list[Ingredient], player_states: Mapping[UUID, PlayerState], player_turn: Optional[UUID]):
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "player_states": {str(player): player_state.to_dict() for player, player_state in self.player_states.items()},
