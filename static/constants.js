...
export const CARD_COST_TOKEN = { karaoke: 'spirit', store: 'spirit', refresher: 'mixer', cup_doubler: 'spirit' };
export const CARD_COST_COUNT = { karaoke: 3, store: 1, refresher: 2, cup_doubler: 3 };
